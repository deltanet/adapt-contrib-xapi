define([
  ...
  'libraries/url-polyfill.min'
    ...
    var XapiFunctions = function() {

      /** Declare defaults and properties */

      // Default properties.
      this.statementLang = 'en-US';
      this.generateIds = false;
      this.activityId = null;
      this.actor = null;
      this.shouldTrackState = true;
      this.shouldUseRegistration = true;
    ...
    // static
    XapiFunctions.instance = null;

    /******************************* public methods *******************************/

    // static
    XapiFunctions.getInstance = function() {
        if (XapiFunctions.instance === null)
            XapiFunctions.instance = new XapiFunctions();

        return XapiFunctions.instance;
    };

    XapiFunctions.prototype.initialize = function() {
      debugger;
      if (!Adapt.config) {
        return;
      }
      ...
      this.initializeWrapper(_.bind(function(error) {
        ...
        this.shouldTrackState = this.getConfig('_shouldTrackState');
    ...
    XapiFunctions.prototype.initializeWrapper = function(callback) {
    ...
    XapiFunctions.prototype.onInitialised = function(error) {
     ...
     */
    XapiFunctions.prototype.setWrapperConfig = function() {
    ...
    */
    XapiFunctions.prototype.checkWrapperConfig = function() {
    ...
    XapiFunctions.prototype.getConfig = function(key) {
     ...
     */
    XapiFunctions.prototype.validateProps = function() {
     ...
     */
    XapiFunctions.prototype.sendStatements = function(statements, callback) {
     ...
     */
    XapiFunctions.prototype.sendStatement = function(statement, callback, attachments) {
      callback = _.isFunction(callback) ? callback : function() { };
     ...
     * @param {array} [attachments] - An array of attachments to pass to the LRS.
     */
    XapiFunctions.prototype.onStatementReady = function(statement, callback, attachments) {
     ...
     */
    XapiFunctions.prototype.getCourseStatement = function(verb, result) {
     ...
     */
    XapiFunctions.prototype.getStatement = function(verb, object, result, context) {
     ...
     */
    XapiFunctions.prototype.getCourseActivity = function() {
     ...
     */
    XapiFunctions.prototype.getLRSAttribute = function(key) {
     ...
     */
    XapiFunctions.prototype.getVerb = function(verb) {
    ...
    XapiFunctions.prototype.sendUnloadStatements = function() {
     ...
     */
    XapiFunctions.prototype.sendStatementsSync = function(statements) {
     ...
     * @param {ErrorOnlyCallback} [callback]
     */
    XapiFunctions.prototype.getState = function(callback) {
      callback = _.isFunction(callback) ? callback : function() { };
     ...
     */
    XapiFunctions.prototype.sendState = function(model, modelState) {
      if (this.shouldTrackState !== true) {
        return;
      }
     ...
     * @param {ErrorOnlyCallback} [callback]
     */
    XapiFunctions.prototype.deleteState = function(callback) {
      callback = _.isFunction(callback) ? callback : function() { };
     ...
     * @param {ADLCallback} [callback]
     */
    XapiFunctions.prototype.processAttachments = function(statement, callback) {
    ...
    XapiFunctions.prototype.getActor = function() {
    ...
    XapiFunctions.prototype.getRegistration = function() {
    ...
    XapiFunctions.prototype.getActivityId = function() {
    ...
    XapiFunctions.prototype.getCurrentState = function(callback) {
      if (_.isEmpty(this.state)) {
    ...
    XapiFunctions.prototype.isXapiInitialised = function(callback) {
    ...
    XapiFunctions.prototype.getAttemptDuration = function() {
      return this.startAttemptDuration + this.getSessionDuration();
    };

    XapiFunctions.prototype.getSessionDuration = function() {
